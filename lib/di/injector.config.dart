...
import '../app/managers/recognize_voice_manager.dart' as _i18;
...
import '../features/searchmodel/presentation/searchmodel_cubit.dart' as _i21;
import '../features/setting/presentation/setting_cubit.dart' as _i22;
import '../features/story/presentation/story_cubit.dart' as _i23;
import '../features/vocabulary/vocabulary_cubit.dart' as _i27;
import '../features/vocabularydetail/vocabulary_detail_cubit.dart' as _i28;
import '../features/welcome/presentation/welcome_cubit.dart' as _i29;
...
_i1.GetIt $initGetit(
  ...
  gh.singleton<_i18.RecognizeVoiceManager>(_i18.RecognizeVoiceManager());
  gh.factory<_i19.RegisterCubit>(() => _i19.RegisterCubit());
  gh.factory<_i20.ResetPasswordCubit>(() => _i20.ResetPasswordCubit());
  gh.factory<_i21.SearchModelCubit>(() => _i21.SearchModelCubit());
  gh.factory<_i22.SettingCubit>(() => _i22.SettingCubit());
  gh.factory<_i23.StoryCubit>(() => _i23.StoryCubit());
  gh.factory<_i24.TermOfServiceCubit>(() => _i24.TermOfServiceCubit());
  gh.factory<_i25.UserInformationCubit>(() => _i25.UserInformationCubit());
  gh.factory<_i26.UserProfileCubit>(() => _i26.UserProfileCubit());
  gh.factory<_i27.VocabularyCubit>(() => _i27.VocabularyCubit());
  gh.factory<_i28.VocabularyDetailCubit>(() => _i28.VocabularyDetailCubit());
  gh.factory<_i29.WelcomeCubit>(() => _i29.WelcomeCubit());
  return getIt;
}
