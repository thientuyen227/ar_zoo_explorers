...
import '../app/managers/recognize_voice_manager.dart' as _i15;
import '../core/data/local_storage/local_storage.dart' as _i12;
...
import '../features/authentication/forgotpassword/presentation/forgotpassword_cubit.dart'
    as _i9;
import '../features/authentication/login/presentation/login_cubit.dart' as _i13;
...
import '../features/learning/presentation/learning_cubit.dart' as _i11;
import '../features/modeldetail/presentation/modeldetail_cubit.dart' as _i14;
import '../features/searchmodel/presentation/searchmodel_cubit.dart' as _i18;
import '../features/setting/presentation/setting_cubit.dart' as _i19;
import '../features/story/presentation/story_cubit.dart' as _i20;
import '../features/welcome/presentation/welcome_cubit.dart' as _i24;
...
_i1.GetIt $initGetit(
  ...
  gh.factory<_i11.LearningCubit>(() => _i11.LearningCubit());
  gh.singleton<_i12.LocalStorage>(_i12.LocalStorageImpl());
  gh.factory<_i13.LoginCubit>(() => _i13.LoginCubit());
  gh.factory<_i14.ModelDetailCubit>(() => _i14.ModelDetailCubit());
  gh.singleton<_i15.RecognizeVoiceManager>(_i15.RecognizeVoiceManager());
  gh.factory<_i16.RegisterCubit>(() => _i16.RegisterCubit());
  gh.factory<_i17.ResetPasswordCubit>(() => _i17.ResetPasswordCubit());
  gh.factory<_i18.SearchModelCubit>(() => _i18.SearchModelCubit());
  gh.factory<_i19.SettingCubit>(() => _i19.SettingCubit());
  gh.factory<_i20.StoryCubit>(() => _i20.StoryCubit());
  gh.factory<_i21.TermOfServiceCubit>(() => _i21.TermOfServiceCubit());
  gh.factory<_i22.UserInformationCubit>(() => _i22.UserInformationCubit());
  gh.factory<_i23.UserProfileCubit>(() => _i23.UserProfileCubit());
  gh.factory<_i24.WelcomeCubit>(() => _i24.WelcomeCubit());
  return getIt;
}
