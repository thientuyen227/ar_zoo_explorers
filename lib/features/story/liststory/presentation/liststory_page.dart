...
import 'package:ar_zoo_explorers/features/story/liststory/presentation/liststory_cubit.dart';
...
class _State extends BaseState<ListStoryState, ListStoryCubit, ListStoryPage> {
  @override
  Widget buildByState(BuildContext context, ListStoryState state) {
    return Scaffold(
