...
import 'package:ar_zoo_explorers/features/puzzledetail/components/dialog_saving.dart';
...
class PuzzleDetailPage extends StatefulWidget {
  const PuzzleDetailPage(
      {super.key, required this.categoryId, required this.continueQuestion});
...
class _State
    extends BaseState<PuzzleDetailState, PuzzleDetailCubit, PuzzleDetailPage> {
