...
class _State extends BaseState<ARState, ARCubit, ARPage> {
  ...
  Future<void> onUnityCreated(UnityWidgetController controller) async {
    ...
    Map<String, dynamic> url = {
      "file": File("/data/data/com.ttcompany.ar_zoo_explorers/files/Carp.glb")
    };
    ...
    // Map<String, dynamic> url = await cubit.getFilePath('Carp', '.glb');
    ...
    Fluttertoast.showToast(msg: "Linkdownload: ${filePath.path}");
